...
export class AI {
    ...
    public findTarget(tick: number) {
        //If Passive Mode is one dont waste time doing this
        ...
        for (let i = 0; i < entities.data.length; ++i) {
            ...
            while (chunk) {
                ...
                if (!this.targetBullets && (entity.relationsData.values.owner !== null && entity.relationsData.values.owner.positionData)) continue;
